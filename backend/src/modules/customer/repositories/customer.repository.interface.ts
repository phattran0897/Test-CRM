...
export const I_CUSTOMER_REPOSITORY = 'ICustomerRepository';

export interface ICustomerRepository {
    findAll(tenantId: string, skip: number, take: number, search?: string): Promise<{ data: CustomerEntity[], total: number }>;
